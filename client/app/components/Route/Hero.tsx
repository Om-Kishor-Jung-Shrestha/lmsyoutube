...
//import studyImg from "@/public/assets/study.png";
    ...
    return (
        <div className="w-full 1000px:flex items-center">
            ...
            <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
                ...
                <Image
                    src={require("../../../public/assets/study.png")}
                    //src="/assets/study.png"
                    //src={study}
                   // src="/assests/study.png"
                    alt=""
                    className="object-contain 1100px:max-w-[70%] w-[70%] 1500px:max-w-[65%] h-auto z-[10]"
                />
