...
const CourseContent: FC<Props> = (
    ...
    const newContentHandler = (item: any) => {
        if (
            ...
            // Add new content
            const updatedCourseData = [...courseContentData, newContent];
            setCourseContentData(updatedCourseData);

            // Expand the new section immediately
                                ...
                                {showSectionInput && (
                                    <>
                                        <div className='flex w-full items-center'>
                                            <input
                                                type="text"
                                                className={`text-[20px] font-Poppins cursor-pointer dark:text-white text-black bg-transparent outline-none ${item.videoSection ? "w-[170px]" : "w-max"
                                                    }`}
                                        ...
                                        {item?.links.map((link: any, linkIndex: number) => (
                                            <div key={linkIndex} className="mb-3 block">
                                                <div className="w-full flex items-center justify-between">
                                                    ...
                                                    <AiOutlineDelete
                                                        className={`text-black dark:text-white text-[20px] ${linkIndex === 0 ? "cursor-no-drop" : "cursor-pointer"
                                                            }`}
                                                        onClick={() =>
